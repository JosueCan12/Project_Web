    ...
    <div className="container bg-gray-200 ">
      <div className="mx-auto bg-white h-14 shadow-sm">
        <ul className="list-none py-3 text-botones font-bold flex justify-center ">
          <Link to="/usuario">
            <li className=" text-fondo text-2xl">Usuarios</li>
          </Link>
        </ul>
      </div>
      ...
      <div className="container mx-auto  ">
        <div className="flex justify-center px-6 my-6 ">
          <div className="w-full xl:w-3/4 lg:w-11/12 flex shadow-lg rounded-l-lg">
            <div
              className="w-full h-auto bg-gray-40 flex py-24 lg:block lg:w-5/12 bg-cover rounded-l-lg bg-blanco"
            ...
            <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
              <h3 className="pt-4 text-2xl text-center font-bold text-blue-700">Create an Account!</h3>
